...
const BelgraveDashboard = () => {
    ...
    const AgentCard = ({ agent }) => {
        ...
        return (
            <div className={`p-5 rounded-xl shadow-md transition-all duration-300 ${isInactive ? 'border-2 border-red-200 bg-white hover:shadow-lg' : 'bg-white hover:shadow-md'
                }`}>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div className="flex items-center space-x-3">
                            <button
                                ...
                                className={`flex items-center justify-center space-x-2 py-2 px-4 rounded-lg font-medium transition-all ${inactiveAgents > 0
                    ...
                    {['marketing', 'community', 'analytics', 'automation'].map((type) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeFilter === type
...
export default BelgraveDashboard;
