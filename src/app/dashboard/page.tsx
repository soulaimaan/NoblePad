...
export default function DashboardPage() {
  ...
  const tierData = useMemo(() => {
    switch(currentTier) {
        case 'GOLD': return { tier: 'Gold', allocation: 5000, color: 'text-yellow-400', benefits: ['Guaranteed allocation', 'Priority access', 'Early project voting', 'Reduced fees'] }
        case 'SILVER': return { tier: 'Silver', allocation: 2500, color: 'text-gray-300', benefits: ['Top-tier allocation', 'Priority access', 'Community voting rights'] }
        case 'BRONZE': return { tier: 'Bronze', allocation: 1000, color: 'text-orange-400', benefits: ['Allocated based on availability', 'Basic project access'] }
        default: return { tier: 'None', allocation: 0, color: 'text-gray-500', benefits: ['Public sale access only'] }
    }
  }, [currentTier])
                            ...
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <div className="px-4 py-2 rounded-lg bg-noble-gold/10">
                                    ...
                                    <div className="text-sm text-noble-gold/70">
                                        ${tierData.allocation.toLocaleString()} allocation
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="noble-card">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-noble-gold font-semibold">${tierData.allocation.toLocaleString()}</span>
                                        </div>
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b border-noble-gold/20">
                                                ...
                                                <th className="px-6 py-4 text-left text-sm font-medium text-noble-gold/70 uppercase tracking-wider">Noble AI</th>
